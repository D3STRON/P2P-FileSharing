...
const provider = new HDWalletProvider(
  'mixed purpose catch minute arrange provide tuition album change direct caution glass',
...
module.exports = {
  dep: async (ipfsHash, decryptionKey, Reciever) => {
    ...
    const result = await new web3.eth.Contract(JSON.parse(interface))
      .deploy({
        data: '0x' + bytecode,
        arguments: [ipfsHash, decryptionKey, Reciever]
      }) // byte code of the S.C. and arguments are the SC cunrtructor argumentn
